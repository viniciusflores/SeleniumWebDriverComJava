...
public class TesteRegrasCadastro {
	...
	public void deveValidarRegras() {
		...
		if(comidas.contains("Carne")) page.setComidaFavCarne();
		if(comidas.contains("Frango")) page.setComidaFavFrango();
		if(comidas.contains("Pizza")) page.setComidaFavPizza();
		if(comidas.contains("Vegetariano")) page.setComidaFavVegetariano();
